...
echo "CONFIG_FIRMWARE_INCLUDE_FFMPEG_NEW=y" >> $1.config
...
echo "CONFIG_FIRMWARE_INCLUDE_NAPT66=y" >> $1.config
...
echo "CONFIG_FIRMWARE_INCLUDE_MTR=y" >> $1.config
echo "CONFIG_FIRMWARE_INCLUDE_SOCAT=y" >> $1.config
echo "CONFIG_FIRMWARE_INCLUDE_SRELAY=y" >> $1.config
